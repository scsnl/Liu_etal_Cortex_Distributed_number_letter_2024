...
if __name__ == '__main__':
    ...
    for ii in range(numsub):
        # print(ii)
        img1 = project_dir + 'results/taskfmri/participants/' + str(pid[ii]).rjust(4,'0') + '/visit' + \
                       str(visit[ii]) + '/session' + str(session[ii]) +'/glm/stats_spm12/letter_swgcar/con_0001.nii'
        img2 = project_dir + 'results/taskfmri/participants/' + str(pid[ii]).rjust(4, '0') + '/visit' + \
                       str(visit[ii]) + '/session' + str(session[ii]) + '/glm/stats_spm12/number_swgcar/con_0001.nii'
    ...
    for mm in range(len(mask_list)):
        ...
        for alpha in param_grid:
            ...
            outputf = 'stanford_new/glmnet_coef_img_alpha_' + str(alpha) + '_' + mask_name + '.nii.gz'
            outputf_abs = 'stanford_new/glmnet_abs_coef_img_alpha_' + str(alpha) + '_' + mask_name + '.nii.gz'
            print(outputf)
            ...
            perm_outputf = 'stanford_new/glmnet_alpha_' + str(alpha) + '_' + mask_name + '_permutation_' + str(no_permutations) + '.npz'
