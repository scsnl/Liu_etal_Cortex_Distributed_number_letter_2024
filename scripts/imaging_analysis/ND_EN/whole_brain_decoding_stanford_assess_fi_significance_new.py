...
if __name__ == '__main__':
    ...
    data_path = 'stanford_new/glmnet_alpha_0.1_stanford_omnibusF_masked_mask_01k0_permutation_5000.npz'
    ...
    f_actual = 'stanford_new/glmnet_abs_coef_alpha_0.1_stanford_omnibusF_masked_mask_01k0.nii.gz'
    coef_img.to_filename(f_actual)

    coef_perm_img = masker.inverse_transform(np.abs(coef_perm))
    f_perm = 'stanford_new/glmnet_abs_coef_perm5000_img_alpha_0.1_stanford_omnibusF_masked_mask_01k0.nii.gz'
